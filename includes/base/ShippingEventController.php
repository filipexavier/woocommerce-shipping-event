...
class ShippingEventController {
  ...
  public function get_post_by_id( $shipping_event_id) {
    ...
    throw new Exception( __('Could not create new object because this is not a Shipping Event Post Type' ) );
  }

  public function get_post_enabled( $shipping_event_id, $meta_key ) {
